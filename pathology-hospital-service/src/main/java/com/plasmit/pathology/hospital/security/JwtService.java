package com.plasmit.pathology.hospital.security;

import com.plasmit.pathology.hospital.common.exception.ApiException;
import com.plasmit.pathology.hospital.context.CurrentUser;
...
public class JwtService {
    ...
    public CurrentUser parseToken(String token) {
        try {
            ...
            return new CurrentUser(userId, tenantId, hospitalId, email, role, userType);
