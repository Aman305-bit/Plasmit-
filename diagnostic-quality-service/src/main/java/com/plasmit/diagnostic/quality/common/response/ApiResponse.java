...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> success(String message, T data) {
        return new ApiResponse<>(true, message, data, new ApiMeta(TenantContext.getRequestId()));
    }

    public static <T> ApiResponse<T> failure(String message, T data) {
        return new ApiResponse<>(false, message, data, new ApiMeta(TenantContext.getRequestId()));
    }
